# Gunakan Docker image resmi Next.js yang dioptimalkan (Node 20 Alpine)
...
# Copy prisma folder if you want to run edge cases (e.g. migrate deploy inside container)
